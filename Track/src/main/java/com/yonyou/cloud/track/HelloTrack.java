...
//		// "http://10.10.11.209:8006/sa?project=default&token=bbb";
//
//		// DebugConsumer
//		// final Track sa = new Track(new Track.DebugConsumer
//		// (SA_SERVER_URL, true));
//		// BatchConsumer
...
//
//		// LoggingConsumer
//		final Track track = new Track(new Track.ConcurrentLoggingConsumer("/file.log"));
//
...
////		track.track(cookieId, false, "ViewProduct", properties); // 记录浏览商品这个event
//
//		// 2. 用户决定注册了
...
////		track.trackSignUp(registerId, cookieId);
//
...
//		profiles.put("Birthday", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("1984-11-03 " + "00:00:00")); // 用户的出生日期，特别注意，这个地方填入年龄是不合适的，因为年龄会随着时间而变化
//		profiles.put("RegisterChannel", "baidu"); // 用户的注册渠道
////		track.profileSet(registerId, true, profiles); // 此时传入的是注册ID了
//
//		// 2.3 立刻刷新一下，让数据传到SA中
//		track.flush();
//
...
////		track.track(registerId, true, "SubmitOrder", properties); // 注意，此时使用的已经是注册ID了
//		// 订单中手机这个商品的信息
//		properties.clear();
//		properties.put("$os", "Windows"); // 通过请求中的UA，可以解析出用户使用设备的操作系统是windows的
//		properties.put("$os_version", "8.1"); // 操作系统的具体版本
...
////		track.track(registerId, true, "SubmitOrderDetail", properties);
//		// 订单中手机膜这个商品的信息
//		properties.clear();
//		properties.put("$os", "Windows"); // 通过请求中的UA，可以解析出用户使用设备的操作系统是windows的
//		properties.put("$os_version", "8.1"); // 操作系统的具体版本
...
////		track.track(registerId, true, "PayOrder", properties);
//
//		// 手机这个商品的支付情况
//		properties.clear();
//		properties.put("$os", "Windows"); // 通过请求中的UA，可以解析出用户使用设备的操作系统是windows的
...
////		track.track(registerId, true, "PayOrderDetail", properties);
//
//		// 手机膜这个商品的支付情况
//		properties.clear();
//		properties.put("$os", "Windows"); // 通过请求中的UA，可以解析出用户使用设备的操作系统是windows的
...
////		track.track(registerId, true, "CancelOrder", properties);
//		// 手机这个商品的取消情况
//		properties.clear();
//		properties.put("$os", "Windows"); // 通过请求中的UA，可以解析出用户使用设备的操作系统是windows的
//		properties.put("$os_version", "8.1"); // 操作系统的具体版本
...
//		properties.put("CancelReason", "地址填写错误"); // 取消订单的原因
//		properties.put("CancelTiming", "AfterPay"); // 取消订单的时机
////		track.track(registerId, true, "CancelOrderDetail", properties);
//		// 手机膜这个商品的取消情况
//		properties.clear();
//		properties.put("$os", "Windows"); // 通过请求中的UA，可以解析出用户使用设备的操作系统是windows的
//		properties.put("$os_version", "8.1"); // 操作系统的具体版本
...
////		track.track(registerId, true, "ReceiveProduct", properties);
//		// 手机膜这个商品的配送情况
//		properties.clear();
//		properties.put("$os", "Windows"); // 通过请求中的UA，可以解析出用户使用设备的操作系统是windows的
//		properties.put("$os_version", "8.1"); // 操作系统的具体版本
